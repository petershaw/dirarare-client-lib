...
Matrix = module.exports = function matrix(x, y) {
	...
	matrix.setTarget = function setTarget(/** argument list of printer fn's */){
		matrix.target = Array.prototype.slice.call(arguments);
	}
	...
	matrix.draw = function draw(){
		...
		_.each(matrix.target, function(target){
