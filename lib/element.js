...
var Element = module.exports = function element(){
	...
	element.setMidPoint 	= function setMidPoint( a, b, c, d ){
    	element.midPoint[0] = (parseInt( a[0] + ((c[0] - a[0]) /2) ));
 		element.midPoint[1] = (parseInt( a[1] + ((c[1] - a[1]) /2) ));
	}
...
Element.prototype.commitPosition = function commitPosition(){
	...
	this.setMidPoint( this.squareBounds[0], this.squareBounds[1], this.squareBounds[2], this.squareBounds[3] );
}
...
Element.prototype.resize = function(value){
	...
	_.each(this.points, function(point){
		console.log("###", point, that.midPoint );
